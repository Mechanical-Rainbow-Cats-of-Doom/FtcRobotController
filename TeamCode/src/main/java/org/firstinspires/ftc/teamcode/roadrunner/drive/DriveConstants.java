...
public class DriveConstants {
     ...
     * empirically tuned.
     */
    public static double kV = 0.0165;  //return to this later
    public static double kA = 0.0031;  //return to this later
    public static double kStatic = 0.001;  //return to this later
