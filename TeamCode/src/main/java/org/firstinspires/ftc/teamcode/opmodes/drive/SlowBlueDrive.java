...
import org.firstinspires.ftc.teamcode.core.robot.shittyodometry.SlowMovement;
 ...
 */
@TeleOp
public class SlowBlueDrive extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        final SlowMovement move = new SlowMovement(hardwareMap, eventThread, moveGamepad, lift, power != 1);
